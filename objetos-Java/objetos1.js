...
//Hace que la función devuelva un objeto con la siguiente información:
...
function createObject(name, subs) {
  const persona = {
    ...
    getStatus: function () {
      return `hola mi nombre es ${name} y mi subs son ${subs} `;
    },
  };
  return persona;
}
const newObject = createObject("jeeee", 20);
console.log(newObject.getStatus());
